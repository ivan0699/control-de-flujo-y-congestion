//
// Generated file, do not edit! Created by nedtool 6.0 from packet.msg.
//
...
void Packet::copy(const Packet& other)
{
    ...
    this->UsedBuffer = other.UsedBuffer;
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->UsedBuffer);
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->UsedBuffer);
...
int Packet::getUsedBuffer() const
{
    return this->UsedBuffer;
}

void Packet::setUsedBuffer(int UsedBuffer)
{
    this->UsedBuffer = UsedBuffer;
}

bool Packet::getDuplicated() const
{
    return this->duplicated;
}

void Packet::setDuplicated(bool duplicated)
{
...
unsigned int PacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_UsedBuffer
        FD_ISEDITABLE,    // FIELD_duplicated
    };
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'U' && strcmp(fieldName, "UsedBuffer") == 0) return base+4;
    if (fieldName[0] == 'd' && strcmp(fieldName, "duplicated") == 0) return base+5;
...
const char *PacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "int",    // FIELD_hopCount
        "int",    // FIELD_type
        "int",    // FIELD_UsedBuffer
        "bool",    // FIELD_duplicated
    };
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_UsedBuffer: return long2string(pp->getUsedBuffer());
        case FIELD_duplicated: return bool2string(pp->getDuplicated());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_UsedBuffer: pp->setUsedBuffer(string2long(value)); return true;
        case FIELD_duplicated: pp->setDuplicated(string2bool(value)); return true;
